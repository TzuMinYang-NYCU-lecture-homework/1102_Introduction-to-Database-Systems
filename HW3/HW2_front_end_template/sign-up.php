				...
				<div class="col-md-4 col-md-offset-4">
					...
					<form action="./php/register_user.php" method="POST" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="user_name" id="user_name" placeholder="Name" autocomplete="off">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="account" id="account" placeholder="Account" autocomplete="off" oninput="check_account(this.value);"><label id="msg"></label><br>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="re_password" class="sr-only">Re-type Password</label>
							<input type="password" class="form-control" name="re_password" id="re-password" placeholder="Re-type Password" autocomplete="off">
						</div>
						<div class="form-group">
